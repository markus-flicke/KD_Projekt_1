...
attribute_id = 1
#dir <- paste(getwd(),"/Plots/AML/", header[attribute_id],"/",header[attribute_id],"_", sep="")
...
chi2Test
a <- AdaptGauss::KStestMixtures(data[,attribute_id], adaptValues$Means, adaptValues$SDs, adaptValues$Weights)
